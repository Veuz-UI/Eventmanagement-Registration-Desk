    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">List of Agenda</h2>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="event-box">
                                    <div class="event-left">
                                        <h3>Conference for architects</h3>
                                        <h6><i class="fa-regular fa-clock me-1"></i>10:30 AM</h6>
                                    </div> 
                                    <div class="event-right">
                                        <a href="home.php"><button type="button" class="btn btn-primary">Check In</button></a>                                     
                                        <a href="home.php"><button type="button" class="btn btn-danger">Check Out</button></a> 
                                    </div>
